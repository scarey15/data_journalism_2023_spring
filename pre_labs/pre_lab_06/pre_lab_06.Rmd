...
**Answer** They are all the same except for the 2020 data, the column of OTH and UNA are switch compared too the rest of the columns.
...
**Answer** The total number of people increases by 2022, most registered as a democrat, increasing by about 18,000 people.
...
**Answer** There are 24 rows now, technically there are only 23 counties in Maryland, but they include Baltimore City into the results. 
...
**Answer** This data shows us the population of people over 18, race population of white, black, Asian, native, pacific and other people in the area. It also shows us if someone is a part of 2 or more races.
...
**Answer** Prince George's County has the highest 18+ Black population, with 77% of the population being democrats.
...
**Answer** Howard County has the highest Asian population over 18, with almost 53% of the population being democrats. The numbers are very low compared to the Black population, this tells us that the population is not majority Asian (as well with the whole state).
...
**Answer** dbl, which means it stores real numbers
...
**Answer** It is a character column
