...
**Answer** 55,632 obs or 7 variables
...
**Answer** Listing each term once and the available classes available in that chunk
...
**Answer** The data is organized in descending order, which was added to the code
...
**Answer** This code block is now arranged by term and department, which was changed in the code.
...
**Answer** This set is now arranged by total seats in each class
...
**Answer** Along with counting classes, the code also adds in the code for the sum of the seats, the mean of the seats and the median of the seats.  The results now show the total seats for each class, the mean seats for each class and the median seats for each class. They all have the largest number of total seats. 
...
**Answer** This code block now sorts by department, and the total seats, the mean seats, and the median seats in each department.  
...
1.  How can you show the departments sorted alphabetically?

2.  Why are there more seats available in Engineering Science classes than there are in Communications classes, when they have almost double the amount of classes than the Engineering department does?

3.  Why does the computer science department have more total seats in classes than English classes? Even when the Englsish department has more classes than the Computer Science department.
