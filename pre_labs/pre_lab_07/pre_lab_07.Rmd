...
```{r echo=FALSE}
census_api_key("2257b2677e5a747de92eaefb9471c94a713e78b1", install=TRUE)
```
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be?
**Answer** Estimated Household income by county in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** Yes, there is more people in Calvert county with a higher estimated income than there is in Montgomery County. This is just an esimate so there isn't a way to show which one is ahead becaue of the margin of error.

Is the difference between Howard and everyone else significant? **Answer** Yes, there is a difference in the leader boards, the chart shows that Howard County is highest. 
...
**Answer**  Howard, Charles, Calvert and Carroll county saw the largest increase in income. No county saw any decline from this period. 
...
**Answer** Which school has the highest amount of high school graduates in the 2019-2020 school year? or What is the reason some zip codes have a higher amount of high school graduates than others? The locations that filter into the schools pay a big part in the answer to these questions, I know a lot of schools have programs that ship kids to different schools because of behavioral issues and education requirements. 
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results.
**Answer** It can be interpreted that the higher the income of the student, the less likely they are to graduate highschool than their poorer counterparts. This is obviously a very broad overview of the whole issue.
...
**Task** What is another question you could ask of this data?
**Answer** What is the difference between students inrolled at the beginning of their high school career, compared too the amount that actually successfully graduated? We could continue to show whoo applied to universities after graduating, compared to the ones who didn't? 
