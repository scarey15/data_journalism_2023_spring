...
**A1.** I described them as what they were, amounts between two numbers, I would change it to something more simple, but I'm afraid I would get confused.
...
maryland_expenses <- maryland_expenses %>%
  mutate(
    category = case_when(
      ...
      amount < 500 ~ "Lees than $500",
      amount < 5000 ~ "Between $500 and $5,000",
      amount < 50000 ~ "Between $5,001 and $50,000",
      amount < 100000 ~ "Between $50,000 and $100,000",
      amount < 500000 ~ "Between $100,000 and $500,000"
...
**A3.** Economics is interesting because it doens't typically have anything to do with climates.
